...
AdamRaichuJsLib.prototype.ctx = function(canvasId, context) {
  var ctx = document.getElementById(canvasId).getContext(context)
}

AdamRaichuJsLib.prototype.ctx2 = function(canvasId, context) {
  var ctx2 = document.getElementById(canvasId).getContext(context)
}
...
AdamRaichuJsLib.prototype.about = function() {
  ...
  console.log("Available Functions: about(); help(); local.array.store(); local.array.get(); edit(); ctx(); ctx2()")
}
...
AdamRaichuJsLib.prototype.help = function(helpWithWhat) {
  ...
  } else if (helpWithWhat === "ctx" || helpWithWhat === "ctx2") {
    console.log("This function is a simplified way to get the context of a canvas. 2 arguments required. cavasId: The id of the canvas. context: the context of the canvas (2d).")
    console.log("Using AR.ctx() will return the context under the variable ctx. AR.ctx2() will return ctx2 as the variable.")
  } else {
